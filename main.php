...
<html class="no-js" lang="zxx">
    <head>
		...
		<link rel="shortcut icon" type="image/x-icon" href="assets/img/brebes2.png">
  ...
  Dinas Kesehatan Sleman - Bidang Pelayanan Medik &copy;<script>document.write(new Date().getFullYear());</script>
